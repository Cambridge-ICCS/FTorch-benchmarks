...
do
    ...
    ./benchmarker_cgdrag_torch ../pytorch saved_cgdrag_model_gpu.pth      $nrun 10 | tee cgdrag_torch_$n.out

    ./benchmarker_resnet_forpy ../resnetmodel resnet18                    $nrun 10 | tee resnet_forpy_$n.out
    ./benchmarker_resnet_torch ../resnetmodel saved_resnet18_model_gpu.pt $nrun 10 | tee resnet_torch_$n.out

    ./benchmarker_large_stride_forpy ../stridemodel run_emulator_stride $nrun $NDIM | tee ls_forpy_$n.out
    ./benchmarker_large_stride_torch ../stridemodel saved_large_stride_model_gpu.pth     $nrun $NDIM | tee ls_torch_$n.out
done
