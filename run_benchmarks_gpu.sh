...
do
    ...
    ./benchmarker_cgdrag_torch ../pytorch saved_cgdrag_model_gpu.pt $nrun 10 | tee cgdrag_torch_$n.out
    ...
    ./benchmarker_large_stride_torch ../stridemodel saved_large_stride_model_gpu.pt $nrun $NDIM | tee ls_torch_$n.out
done
