...
do
    ...
    ./benchmarker_cgdrag_torch ../cgdrag_model saved_model.pth      $nrun 10 | tee cgdrag_torch_$n.out
    ...
    ./benchmarker_large_stride_torch ../large_stride_model saved_model.pth     $nrun $NDIM | tee ls_torch_$n.out
done
